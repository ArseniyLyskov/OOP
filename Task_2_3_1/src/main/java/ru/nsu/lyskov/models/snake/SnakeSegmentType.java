...
public enum SnakeSegmentType {
     ...
     *
     * <p>Пример: В некоторый момент времени голова змейки указывает вверх. В последующее
     * перемещение змейка повернулась вправо, её новая голова справа от предыдущей и указывает
     * вправо. Тип сегмента старой головы заменяется на поворотный "буквой Г" - поворот,
     * связывающий сегмент снизу и сегмент справа (BODY_TURN_DOWN_RIGHT).
     *
